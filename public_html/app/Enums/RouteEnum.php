...
class RouteEnum
{
    const CHANNELS_INDEX = 'channels.index';
    const CHANNELS_SHOW = 'channels.show';
    const CHANNELS_UPDATE = 'channels.update';
    const CHANNEL_UPLOAD = 'channel.video.upload';
    const CHANNEL_VIDEOS_UPLOAD = 'channel.videos.upload';
    ...
    const VIDEOS_UPDATE_VIEWS = 'videos.updateViews';
    const VIDEOS_COMMENTS = 'videos.comments';
    const VIDEOS_UPDATE = 'videos.update';
    const VIDEOS_GET_OBJECT_TAGS = 'videos.object_tags';
    const COMMENTS_REPLIES = 'comments.replies';
