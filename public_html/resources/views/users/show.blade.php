                ...
                <div class="card-body">
                    ...
                    @endif --}}
                        ...
                        <div class="form-group row justify-content-center ">
                            <div class="channel-avatar rounded-circle">
                                {{-- @if($channel->editable())
                                    <div onclick="document.getElementById('image').click()" class="channel-avatar-overlay rounded-circle">
                                        <svg xmlns="http://www.w3.org/2000/svg"  xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 60 60" style="enable-background:new 0 0 60 60;" xml:space="preserve" width="50px" height="50px" class="">
                                            <g>
                                                <g>
                                ...
                                <avatar-user :image="'{{ isset($user->channel) && $user->channel->image() }}'" :href="''" :username="'{{ addslashes($user->name) }}'" :size=100 :rounded=true ></avatar-user>
