                            ...
                            <li class="nav-item dropdown">
                                <div class="row">
                                    <div class="px-1" style="width: 3rem;">
                                        <avatar-user :image="'{{ $channel->image() }}'" :href="'{{ route(\App\Enums\RouteEnum::CHANNELS_SHOW, auth()->user()->channel()->first()->id ) }}'" :username="'{{ Auth::user()->name }}'" :size=35 :rounded=true ></avatar-user>
                                    </div>
                                    <div class="px-1">
